#' SMART stop words
#'
#' A vector containing the SMART information retrieval system stop words. See
...
smart_words <-
  c("a", "a's", "able", "about", "above", "according", "accordingly",
    ...
    "g", "get", "gets", "getting", "given", "gives", "go", "goes",
    ...
    "x", "y", "yes", "yet", "you", "you'd", "you'll", "you're", "you've",
